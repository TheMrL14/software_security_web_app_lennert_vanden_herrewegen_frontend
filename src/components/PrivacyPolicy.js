  ...
  render() {
    return (
      <div className="container">
        <h1>Privacy Policy for Belgium Movie Club</h1>

        <p>
          At Belgium Movie Club, accessible from lennertvh.xyz, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Belgium Movie Club and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Belgium Movie Club. This policy is not
        ...
        <p>
          Belgium Movie Club follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, Belgium Movie Club uses 'cookies'. These
        ...
        <p>
          ...
          advertising partners of Belgium Movie Club.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Belgium Movie Club, which are
        ...
        <p>
          Note that Belgium Movie Club has no access to or control over these
        ...
        <p>
          Belgium Movie Club's Privacy Policy does not apply to other
        ...
        <p>
          Belgium Movie Club does not knowingly collect any Personal
